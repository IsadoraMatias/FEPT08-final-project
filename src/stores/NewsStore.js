...
export const useNewsStore = defineStore('news',{
    ...
    getters:{
        getNews: (state) => state.news, //traer las newws
    ...
    actions: {
        async fetchNews() {
            try {
                ...
                const response = await fetch(`https://newsapi.org/v2/everything?q=women+in+technology&sortBy=publishedAt&apiKey=${import.meta.env.VITE_API_KEY}`);

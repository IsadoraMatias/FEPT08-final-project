<template>
  <div class="flex h-screen w-full flex-col items-center justify-center rounded-lg p-6 bg-custom-pink ">
    <div class="grid h-full w-full grid-cols-10 grid-rows-5 gap-4">
      ...
      <!-- item News -->
      <div
        class="col-span-4 row-span-3 rounded-3xl bg-custom-green flex flex-col drop-shadow-xl justify-center items-center cursor-pointer hover:scale-70 active:scale-95 transition-transform duration-200"
        id="news-item" @click="goToNewsPage">
        <div v-if="randomNews"
